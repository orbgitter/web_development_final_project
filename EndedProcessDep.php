    ...
    <div id="wrapper">
       ...
       <main>
           <div class="QrScanner">
               ...
               <a id="QR" href="#"></a>
               <div class='box'>
                   <p>the process finish. press ok for success and return to home page. </p>
                   <div class="buttons">
                        <button type="button" class="btn btn-success btn-primary btn-lg" href="index.html">accept</button>
                   </div>
               </div>
           </div>
